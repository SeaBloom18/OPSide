 ...
 */
class DealerInteractor @Inject constructor(private val sp: Preferences, private val firestore: FirebaseFirestore) {
    ...
    fun showAboutInfo(): Triple<String?, String?, String?> =
        Triple(sp.getString(SP_ADDRESS), sp.getString(SP_LINE_BUSINESS), sp.getString(
            SP_USER_URL_PHOTO))
